...
def saveYieldStats(config, period = 'Last5yrs', prct2retain=100):
    ...
    stats = b100_load.LoadLabel_check_quality_and_clean(stat_fileLAST_VERSION, config.year_start, config.year_end, make_charts=True, perc_threshold=-1, crops_names=config.crops)
