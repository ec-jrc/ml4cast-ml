...
if study == 'ZAeast':
    # TEMPLATE_OUTPUT = r'X:\PY_data\ML1_data_input\SA_mapping\SA_template.tif'
    ...
    TEMPLATE_OUTPUT = dm_cst.TEMPLATE_OUTPUT_gaul2_Ukraine
    ...
    output_path = dm_cst.output_path_gaul2_Ukraine
