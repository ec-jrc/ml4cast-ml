...
#echo ${3} ${4} ${5}
# export MPLCONFIGDIR=/scratch/ml4castproc
# conda activate /mnt/jeoproc/envs/ML4CAST/YF3_dock_p311
/mnt/jeoproc/envs/ML4CAST/YF3_dock_p311/bin/python3.11 /eos/jeodpp/data/projects/ML4CAST/ml4cast-ml/condor_launcher.py ${3} ${4} ${5}
